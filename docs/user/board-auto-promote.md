...
A second switch, **Include sub-board children**, is off by default. Turn it on if children on a
split should follow the same rule. It does nothing unless the first switch is on.
