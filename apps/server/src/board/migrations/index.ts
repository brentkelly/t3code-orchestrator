...
import Migration016 from "./016_BoardThreadTodos.ts";
import Migration017 from "./017_BoardCardActivityStructured.ts";
...
export const BOARD_MIGRATIONS = [
  ...
  [16, "BoardThreadTodos", Migration016],
  [17, "BoardCardActivityStructured", Migration017],
] as const;
