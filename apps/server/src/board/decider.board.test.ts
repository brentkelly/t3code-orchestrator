  ...
  it.effect("no command except an explicit board.card.move emits a move into building", () =>
    Effect.gen(function* () {
      ...
      const catalog: { readonly [K in BoardCommand["type"]]: BoardCommand } = {
        ...
        // emit no move.
        "board.card.record-publish": {
          type: "board.card.record-publish",
          commandId: CommandId.make("cmd-record-publish"),
          cardId: BoardCardId.make("card-ready"),
          publish: {
            round: 0,
            status: "succeeded",
        ...
        // Provider cooldowns (T3O-22): the third aggregate that carries no
        // card at all.
        "board.provider-limit.record": {
          type: "board.provider-limit.record",
          commandId: CommandId.make("cmd-limit-record"),
          limit: {
            ...
            sourceCardId: BoardCardId.make("card-ready"),
            knownTime: true,
            blindSince: null,
            probeCardId: null,
            setByHuman: false,
        ...
        "board.provider-limit.clear": {
          type: "board.provider-limit.clear",
          commandId: CommandId.make("cmd-limit-clear"),
          providerInstanceId: ProviderInstanceId.make("claudeAgent"),
          createdAt: NOW,
        },
      };
