...
// T3o: board migrations are numbered from 900_ so they never collide upstream.
import Migration0900 from "./Migrations/900_BoardCards.ts";
...
export const migrationEntries = [
  ...
  // T3o: board card projection table.
